...
def main():
    ...
    while True:
        ...
        try: 
            ...
            counter1 = int(input("Please put in how many how many time you would like the letters to repeat. "))
        
            lenght = (len(word))
        
            if lenght < number:
                print("")
                print("please put in a valid number of how many letters you would like. ")
                break
